    ...
    public partial class FrmLlamador : Form
    {
        ...
        private void btnLlamar_Click(object sender, EventArgs e)
        {
            if (txtDestino.Text[0] == '#')
            {
                ...
                Provincial llamada = new Provincial(txtOrigen.Text, franja, new Random().Next(1, 50), txtDestino.Text);
            ...
            else
            {
                ...
                Local llamada = new Local(txtOrigen.Text, new Random().Next(1, 50), txtDestino.Text, (float)new Random().Next(5, 56) / 10);
                if (!ReferenceEquals(llamada, null))
                {
                    this.centralita += llamada;
                    MessageBox.Show("Llamada realiza con exito\n");
